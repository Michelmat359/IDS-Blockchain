...
class BlockchainManager:
    ...
    def get_registered_hash(self, tx_hash):
        ...
        if receipt and 'input' in receipt:
            # Convierte el HexBytes en cadena hexadecimal
            return self.web3.to_text(hexstr=receipt['input'].hex())
        raise ValueError("No se encontró 'input' en la transacción.")
